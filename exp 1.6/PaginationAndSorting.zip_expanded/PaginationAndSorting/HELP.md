...
* The original package name 'com.24BDS3A.PaginationAndSorting' is invalid and this project uses 'com._BDS3A.PaginationAndSorting' instead.
...
* [Spring Cache Abstraction](https://docs.spring.io/spring-boot/4.0.8/reference/io/caching.html)
